...
### 228. **Tathā dvande pāṇi turiya yogga senaṅga khuddajantuka vividha viruddha visabhāgatthādīnañca** (And in dvanda compounds for terms denoting body parts, musical instruments, implements, parts of an army, small creatures, various, opposed, and dissimilar meanings, etc.)
...
"Various and opposed" (**vividhaviruddhā**) means things that are diverse in form and opposite in nature. "Dissimilar" (**visabhāgā**) refers to things that are similar yet diverse. Just as in digu compounds, in dvanda compounds terms denoting body parts and similar categories take singular number and neuter gender.

Examples:
Cakkhusotaṃ (eye and ear), gītavāditaṃ (song and instrumental music), yuganaṅgalaṃ (yoke and plow), hatthassaṃ (elephant and horse), asicammaṃ (sword and shield), ḍaṃsamakasaṃ (gadfly and mosquito), kokālūkaṃ (owl and wolf).

Nāmarūpaṃ (name and form): name has the characteristic of bending, form has the characteristic of being affected. Thus these phenomena are diverse in characteristics but similar in ultimate reality.

The term "ādi" (etc.) includes other cases as well. For example:
For different genders - itthipumaṃ (woman and man). With short vowels due to the rule beginning with "ya": dāsidāsaṃ (female and male slaves), pattacīvaraṃ (bowl and robe). Gaṅgāsoṇaṃ (Ganges and Sona rivers).

For numbers and measures - tikacatukkaṃ (three and four).

For craftsmen - veṇarathakāraṃ (basket-maker and chariot-maker).

For hunters - sākuntika māgavikaṃ (bird-catcher and deer-hunter).

For non-living things - ārasatthi (spoke and hub).

For Brahmins who study together - kaṭhakālāpaṃ (Kaṭha and Kalāpa), and so forth.
