...
### §57 (71): Ālapane si ga sañño (the vocative or non-inflected form is represented by `si` and `ga`) :badge[rūḷhī]{variant=note}
...
### §83 (67): Saralopo’ mādesa paccayādimhi saralope tu pakati (vowel elision in `aṃ` [inflections], replacements, suffixes etc., with that vowel elision, [what follows retain] natural form) :badge[utsarga]{variant=success}
...
> | however | vowel elision | `aṃ` [inflections], replacements, suffixes etc. | natural form | | | |
...
There is vowel elision in `aṃ` inflections, replacements, suffixes, etc. and because of that vowel elision what follows retains it's natural form.
