...
>
> The option marker `kvaci` indicates this cancels the `vā` option marker in the previous rule [§13 (15): Vā paro asarūpā (Optionally, next dissimilar-sounding [vowel])](#m13). It provides an alternative to rule [§12 (13): Sarā sare lopaṃ (Vowel, before vowel, is elided)](#m12).
