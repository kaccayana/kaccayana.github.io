...
> [!NOTE]
> `vaṇṇa` can have various meanings, including "colour", "appearance" and "praise" but in the context of Kaccāyana it means "phoneme" or "syllable".
...
### 17 (19): Yamedantassādeso (`v` from `o` or `u` ending)
