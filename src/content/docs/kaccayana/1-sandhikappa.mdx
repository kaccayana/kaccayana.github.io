...
> | option | before | from | operation | to | after | context |
> | --- | --- | --- | --- | --- | --- | --- |
> | (kvaci) | (sarā) | para | ṭhāne | dvebhāvo | | | |
> | (occasionally) | (vowel) | next [consonant] | replace | doubled | | | |
...
> | option | before | from | operation | to | after | context |
> | --- | --- | --- | --- | --- | --- | --- |
> | (kvaci) | (sarā) | Vagge ghosāghosānaṃ | (ṭhāne) | (dvebhāvo) tatiyapaṭhamā | | | |
> | (occasionally) | (vowel) | voiced and unvoiced consonants [ending in `h`] | replace | first letter of consonant (doubled) | | | |
>
